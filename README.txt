...
Define the integer neg, which contains the size of the (1,1)-block for the augmented system, or 0 for the normal equations.

Define a right-hand side rhs, which will be overwritten with the solution of M^{-1} * rhs.

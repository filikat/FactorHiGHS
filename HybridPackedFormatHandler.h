...
class HybridPackedFormatHandler : public FormatHandler {
  ...
  void assembleFrontalMultiple(int num, const std::vector<double>& child, int nc, int child_sn,
  ...
  void assembleClique(const std::vector<double>& child, int nc, int child_sn) override;
